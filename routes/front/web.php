...
Route::group(['namespace' => 'Front'], function () {
    ...
    // Liên hệ
    Route::get('/connect-us.html','FrontController@connectUs')->name('front.connect-us');
    Route::get('/contact-us.html','FrontController@contactUs')->name('front.contact-us');
    Route::post('/contact-us','FrontController@postContact')->name('front.post-contact');

    // Blogs
    Route::get('/about-us.html','FrontController@aboutUs')->name('front.about-us');
    Route::get('/blogs.html','FrontController@indexBlog')->name('front.index-blog');
    Route::get('/blogs/{slug}.html','FrontController@listBlog')->name('front.list-blog');
    Route::get('/detail-blog/{slug}.html','FrontController@detailBlog')->name('front.detail-blog');

    // Chính sách
    Route::get('/policy/{slug}.html','FrontController@policyDetail')->name('front.policy-detail');
    ...
    // services
    Route::get('/services/{slug}.html','FrontController@serviceDetail')->name('front.service-detail');

    // video gallery
    Route::get('/video-gallery','FrontController@videoGallery')->name('front.video-gallery');
});
