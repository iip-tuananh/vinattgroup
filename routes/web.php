...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::group(['prefix' => 'about'], function () {
            Route::get('/', 'Admin\AboutController@index')->name('about.index');
            Route::get('/edit', 'Admin\AboutController@edit')->name('about.edit');
            Route::post('/{id}/update', 'Admin\AboutController@update')->name('about.update');
        });
