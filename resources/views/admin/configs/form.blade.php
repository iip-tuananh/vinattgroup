		...
		<div class="row">
			<div class="col-md-8 col-xs-12">
				<div class="form-group custom-group">
					<label class="form-label required-label">Title website</label>
                ...
                <div class="form-group custom-group">
                    <label class="form-label">Short name company</label>
                ...
                <div class="form-group custom-group">
                    <label class="form-label">Switchboard</label>
                    <input class="form-control" ng-model="form.phone_switchboard" type="text">
                </div>
                <div>
                    <label class="form-label">Add zalo chat (can add multiple zalo chat) <span class="text-success cursor-pointer" ng-click="form.addZaloChat()">( + )</span></label>
                    <div class="row" ng-repeat="(index, zalo) in form.zalo_chat">
                        ...
                        <div class="col-md-5">
                            <div class="form-group custom-group">
                                <label class="form-label required-label">Zalo</label>
                ...
                <div class="form-group custom-group">
                    <label class="form-label">Address production</label>
				...
				<div class="form-group custom-group">
					<label class="form-label required-label">Web description</label>
			...
			<div class="col-md-4 col-xs-12">
				<div class="form-group text-center mb-4">
					...
					<div class="main-img-preview">
						<p class="help-block-img">* Image format: jpg, png, not more than 1MB.</p>
						...
						<div class="input-group-btn" style="margin: 0 auto">
							<div class="fileUpload fake-shadow cursor-pointer">
								<label class="mb-0" for="<% form.image.element_id %>">
									<i class="glyphicon glyphicon-upload"></i> Choose image
								</label>
                ...
                <div class="form-group text-center mb-4">
                    ...
                    <div class="main-img-preview">
                        <p class="help-block-img">* Image format: jpg, png, not more than 1MB, size 16x16</p>
