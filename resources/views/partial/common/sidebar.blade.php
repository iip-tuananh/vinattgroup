    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-flat" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview  {{ request()->is('admin/posts') || request()->is('admin/posts/*') || request()->is('admin/post-categories') || request()->is('admin/post-categories/*') ? 'menu-open' : '' }} ">
                ...
                <a href="#" class="nav-link {{ Request::routeIs('PostCategory.index') || Request::routeIs('PostCategory.create') || Request::routeIs('PostCategory.edit') || Request::routeIs('PostCategory.show') || Request::routeIs('Post.index') || Request::routeIs('Post.create') || Request::routeIs('Post.edit') || Request::routeIs('Post.show') ? 'active' : '' }}">
            ...
            <li class="nav-item has-treeview  {{ request()->is('admin/stores') ||  request()->is('admin/banners') ||  request()->is('admin/origins') || request()->is('admin/manufacturers/*') || request()->is('admin/attributes') ? 'menu-open' : '' }} ">
                ...
                <a href="#" class="nav-link {{ Request::routeIs('origins.index') || Request::routeIs('manufacturers.index') || Request::routeIs('attributes.index') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-newspaper"></i>
                    <p>
                        Danh mục khác
                        <i class="fas fa-angle-left right"></i>
...
{{--                    </li>--}}
            ...
            <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('User.index') }}" class="nav-link {{ Request::routeIs('User.index') || Request::routeIs('User.create') || Request::routeIs('User.edit') || Request::routeIs('User.show') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Tài khoản</p>
                        </a>
                    </li>
