...
class FrontController extends Controller
{
    ...
    public function homePage()
    {
        ...
        $data['services'] = Service::query()->where('status', 1)->get();
        $data['special_products'] = Product::query()->where('status', 1)->limit(8)->orderBy('id', 'DESC')->inRandomOrder()->get();

        $data['about'] = About::with([
            'image',
    ...
    public function aboutUs()
    {
        ...
        return view('site.about_us', compact('content', 'about', 'title', 'description'));
    }
    ...
    public function serviceDetail($slug)
    {
        ...
        return view('site.services.service_detail', compact('content', 'title', 'services', 'description', 'service'));
    }

    // video gallery
    public function videoGallery()
    {
        $videos = Review::query()->orderBy('id', 'desc')->get();
        return view('site.video_gallery', compact('videos'));
    }
}
